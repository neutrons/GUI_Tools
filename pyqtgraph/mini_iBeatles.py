...
widget_1 = pg.ImageView()
widget_1.ui.roiBtn.hide()
widget_1.ui.menuBtn.hide()


widget_2 = pg.ImageView()
...
roi = pg.RectROI([20, 20], [100, 100], pen=(0.9))

widget_1.setImage(data[-1])
widget_1.addItem(roi)
...
#layout = QtGui.QVBoxLayout(plot_widget)
...
#image_top = pg.ImageView()
#image_bottom = pg.ImageView()

#layout = QtGui.QVBoxLayout()
#image_top.setLayout(layout)
#image_bottom.setLayout(layout)
